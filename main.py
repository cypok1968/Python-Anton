...
#         # используем длину алфавита в 33 буквы (для символа ю 31+3=34%33=1 получаем символ б)
#         new_key = (t + key) % len(alphabet) # формула для шифра Цезаря
#         #new_key = (t + key) % len(alphabet)  # формула для дешифрации Цезаря
#
